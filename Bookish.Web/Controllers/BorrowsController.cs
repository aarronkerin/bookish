...
namespace Bookish.Web.Controllers
{
    public class BorrowsController : Controller
    {
        ...
        {
            var borrows = db.Borrows.Include(b => b.Borrower);
        ...
        {
            ViewBag.BorrowID = new SelectList(db.Borrowers, "BorrowerID", "FirstName");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BorrowID,BorrowDate,BorrowReturn")] Borrow borrow)
        {
            if (ModelState.IsValid)
            {
